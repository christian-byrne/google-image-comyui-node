...
function getResponsePadding() {
    return 0.08 * (window === null || window === void 0 ? void 0 : window.innerHeight) || 12;
}
...
export function appendGETresponse(node, liteGraph, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        requestAnimationFrame(() => {
            const mainContainer = document.querySelector(`#${nodeConfig.mainContainerId}`);
            ...
            const handleInitialResize = (graphChangeEvent) => {
                if (graphChangeEvent === null || graphChangeEvent === void 0 ? void 0 : graphChangeEvent.detail) {
                    const graphState = graphChangeEvent.detail;
                    const nodeState = graphState.nodes.find((n) => n.id === node.id);
                    if ((nodeState === null || nodeState === void 0 ? void 0 : nodeState.size) !== startSize) {
                        document
                            .querySelector(`#${nodeConfig.getResponseId}`)
                            .setAttribute("style", "height: -webkit-fill-available;" + JSON_PRE_STYLE);
